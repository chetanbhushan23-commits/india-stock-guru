...
const rootRouteChildren = { IndexRoute, StockSymbolRoute, AiAssistantRoute, StockChatRoute, StockChatSymbolRoute, ResearchHistoryRoute, ResearchRoute, EvidenceRoute, CompareRoute, PortfolioIntelligenceRoute, ResearchAlertsRoute, ResearchReportRoute }
