...
export interface FileRouteTypes { fileRoutesByFullPath:FileRoutesByFullPath; fullPaths:'/'|'/stock/$symbol'|'/ai-assistant'|'/stock-chat'|'/stock-chat/$symbol'|'/research-history'|'/research'|'/evidence'|'/compare'|'/portfolio-intelligence'|'/research-alerts'|'/research-report'|'/research-watchlist'|'/research-timeline'; fileRoutesByTo:FileRoutesByTo; to:FileRouteTypes['fullPaths']; id:'__root__'|FileRouteTypes['fullPaths']; fileRoutesById:FileRoutesByFullPath }
declare module '@tanstack/react-router' { interface FileRoutesByPath { '/research-alerts':{id:'/research-alerts';path:'/research-alerts';fullPath:'/research-alerts';preLoaderRoute:typeof ResearchAlertsRouteImport;parentRoute:typeof rootRouteImport}; '/research-report':{id:'/research-report';path:'/research-report';fullPath:'/research-report';preLoaderRoute:typeof ResearchReportRouteImport;parentRoute:typeof rootRouteImport}; '/research-watchlist':{id:'/research-watchlist';path:'/research-watchlist';fullPath:'/research-watchlist';preLoaderRoute:typeof ResearchWatchlistRouteImport;parentRoute:typeof rootRouteImport}; '/research-timeline':{id:'/research-timeline';path:'/research-timeline';fullPath:'/research-timeline';preLoaderRoute:typeof ResearchTimelineRouteImport;parentRoute:typeof rootRouteImport} } }
const rootRouteChildren = { IndexRoute, StockSymbolRoute, AiAssistantRoute, StockChatRoute, StockChatSymbolRoute, ResearchHistoryRoute, ResearchRoute, EvidenceRoute, CompareRoute, PortfolioIntelligenceRoute, ResearchAlertsRoute, ResearchReportRoute, ResearchWatchlistRoute, ResearchTimelineRoute }
